...
import { GreetingCard, QuickActions, ServicePlanCard } from "../tabs-index";
...
const NurseContainer = () => {
  ...
  return (<View className="p-4">
    ...
    <View style={{ gap: 16, marginBottom: 32 }}>
      ...
      <ServicePlanCard title="居家护理服务" time="14:00-16:00" insuredName="李爷爷" address="海淀区中关村大街1号" status="待服务" items={["生活护理", "健康检测", "康复训练"]} />
    </View>
    {/* 快捷功能标题 */}
    <View style={{ marginBottom: 16 }}>
